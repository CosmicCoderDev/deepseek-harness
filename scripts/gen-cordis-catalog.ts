...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SubagentEnvironmentPolicy: 'subagent.md',
  SubagentEnvironmentRequest: 'subagent.md',
  SubagentPermissionCeiling: 'subagent.md',
  SubagentPermissionRequest: 'subagent.md',
  SubagentPermissionTier: 'subagent.md',
